...
const GiftCards = () => {
  return (
    <section className="py-24 bg-[var(--color-neutral-light)] text-[var(--color-neutral)] border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="flex-1 w-full flex justify-center">
            <div className="relative w-full max-w-md aspect-[1.6/1] bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 shadow-2xl transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500 border border-gray-800 flex flex-col justify-between">
              <div className="flex justify-between items-start">
                <span className="text-2xl font-[var(--font-headline)] text-[var(--color-primary)] tracking-tight">DineGrid</span>
                <span className="text-white/40 font-mono text-sm tracking-widest">GIFT CARD</span>
              </div>
              <div className="flex justify-between items-end">
                <div className="space-y-1">
                  <div className="text-white/50 text-xs tracking-widest uppercase">Value</div>
                  <div className="text-white text-3xl font-[var(--font-headline)]">$250</div>
                </div>
